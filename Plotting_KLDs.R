...
ggsave(file = paste(OUTPUT_ROOT, "/KLD_plot_divergene_from_data.pdf",  sep=""),KLD_plot_divergene_from_data, scale=1)
ggsave(file = paste(OUTPUT_ROOT, "/KLD_plot_divergene_from_data.eps",  sep=""),KLD_plot_divergene_from_data, scale=1)
