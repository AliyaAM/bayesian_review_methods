...
Enablers_HumanvsChatGPT = plot_HumanvsChatGPT + facet_grid(cols = vars(factor(construct_name, levels = c("Beliefs about consequences", # order the grid columns by percent quote (from largest to smallest)
...
Barriers_HumanvsChatGPT = plot_HumanvsChatGPT_barrier + facet_grid(cols = vars(factor(construct_name, levels = c("Beliefs about capabilities", # order the grid columns by percent quote (from largest to smallest)
